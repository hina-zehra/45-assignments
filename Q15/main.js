...
var guests = ["Waliha", "Amna", "Khadija", "Musfira", "Fatima"];
var unAbleTojoin = "Fatima";
console.log("".concat(unAbleTojoin, " can't make it to dinner tonight!"));
var newInvite = "Mariam";
guests[guests.indexOf(unAbleTojoin)] = newInvite;
guests.forEach(function (guest) {
    console.log("Hi ".concat(guest, " , I would like to invite you for a dinner tonight at hotel TAJ MAHAL "));
});
// or
// used for of loop ..
