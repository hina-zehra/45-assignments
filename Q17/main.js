...
//prev ANS:
var guests = ["Waliha", "Amna", "Khadija"];
console.log("congrats! , i've found a bigger table !!");
guests.unshift("Fatima");
guests.splice(guests.length / 2, 0, "Musfira");
guests.push("Mariam");
guests.forEach(function (guest) {
    console.log("Hi! ".concat(guest, " , i would like to inform you that you are invited for a dinner at hotel del luna! "));
});
//Q17 sol:
console.log("sorry! i can invite only 2 people");
while (guests.length > 2) {
    var removed = guests.pop();
    console.log("sorry! ".concat(removed, ", you're not invited at today's dinner"));
}
guests.forEach(function (guest) {
    console.log("Hi ".concat(guest, ", you're still invited please be there on time!"));
});
guests.splice(0, 2);
console.log(guests);
// OR 
